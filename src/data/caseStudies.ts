  ...
  },
  {
    ...
    blocks: [
...

      {
        ...
        id: "the-problem",
        number: "01",
        label: "Where the tools fall short",
        intro: "Therapy tools are built around the hour in the room. Most of what changes for a client happens in the other 167.",
      },
...

      {
        ...
        id: "the-solution",
        number: "02",
        label: "Designing for both sides",
        intro: "Every tool we looked at picked a side, therapist or client. Airy had to work for both, and for the relationship between them.",
      },
...

      {
        ...
        id: "validation",
        number: "04",
        label: "What therapists and clients said",
      },
